            ...
            <div className="chat-input__smiley__box flex flex-col pb-3 -mt-2">
                <div className="px-3 pt-5">
                    <div className="relative">
                        <input
                            type="text"
                            className="form-control bg-gray-200 border-transparent pr-10"
                            placeholder="Search emojis..."
                        />
                        <i
                            className="w-5 h-5 absolute my-auto inset-y-0 mr-3 right-0"
                            data-feather="search"
                        />
                    </div>
                </div>
                <div
                    className="chat-input__smiley__box__tabs text-gray-600 nav nav-tabs flex px-3 mt-5"
                    role="tablist"
                >
                    <a
                        data-toggle="tab"
                        data-target="#history"
                        href="javascript:;"
                        className="py-2 flex justify-center flex-1 rounded hover:bg-gray-200 dark:hover:bg-dark-2 active"
                        id="history-tab"
                        role="tab"
                    ...
                    <a
                        ...
                        data-target="#smile"
                        href="javascript:;"
                        className="py-2 flex justify-center flex-1 rounded hover:bg-gray-200 dark:hover:bg-dark-2"
                        id="smile-tab"
                        role="tab"
                        aria-controls="smile"
                        aria-selected="false"
            ...
            >
                ...
                <div className="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                    <div className="grid grid-cols-8 text-2xl">
                        <button className="rounded hover:bg-gray-200 dark:hover:bg-dark-2 focus:outline-none">
                            😀
                        </button>
                        <button className="rounded hover:bg-gray-200 dark:hover:bg-dark-2 focus:outline-none">
                            😁
